...
impl TimeManagment {
    pub fn new(time_left: i64, increment: i64, moves_to_go: Option<u64>) -> TimeManagment {
        TimeManagment {
            time_left,
            increment,
    ...
    pub fn has_time_for_next_iteration(&self, last_iteration_time: u128) -> bool {
        ...
        let allocated_time = ((self.time_left + self.increment) / moves_to_go as i64) as u128;
